...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 06, 2021 at 08:32 PM
...
(9, 'Forouzan', '', 'ACTIVE'),
(10, 'Dr. Mohammad Kaykobad', '', 'DELETED'),
(11, 'Brian W. Kernigham', '', 'DELETED');
...
(1, 'Maa, Maa,Maa Abong Baba', '1234', 0, 1, 'Bengali', '200', 4, '2021-03-15', '1', '2021-03-01 19:48:06', 1, '', 'Available', 1, 250, 250, 260, 'Cumilla', '20', 'DELETED'),
(2, 'Jibon Jekhane Jemon', '12367', -1, 1, 'Bengali', '235', 4, '2020-11-01', '2', '2020-10-24 19:52:17', 1, '', 'Available', 1, 240, 240, 250, 'dhaka', '20', 'ACTIVE'),
(3, 'Deyal', '8765', -3, 3, 'Bengali', '300', 1, '2020-03-18', '3', '2021-03-09 19:54:39', 3, '', 'Available', 2, 260, 260, 270, 'chittagong', '10', 'ACTIVE'),
(4, 'Oppekha', '233', -2, 4, 'Bengali', '150', 1, '2021-05-29', '5', '2021-04-25 13:32:39', 1, '', 'Available', 1, 300, 300, 320, 'Chittagong', '30', 'ACTIVE'),
(5, 'Ognibina', '2339', -3, 2, 'Bengali', '400', 2, '2021-05-14', '5', '2021-04-25 13:35:14', 3, '', 'Available', 2, 350, 360, 370, 'Cumilla', '15', 'ACTIVE'),
(6, 'Ordhobritto', '7889', -1, 5, 'Bengali', '200', 7, '2021-04-25', '1', '2021-04-25 13:37:30', 4, '', 'Available', 1, 280, 280, 290, 'Cumila', '20', 'ACTIVE'),
(7, 'Dipu Number Two', '9870', 0, 4, 'Bengali', '320', 6, '2021-03-28', '1', '2021-04-28 13:20:41', 1, '', 'Available', 1, 345, 345, 365, 'cumilla', '20', 'ACTIVE'),
(8, 'Ami Topu', '2030', -1, 2, 'Bengali', '240', 6, '2005-04-10', '1', '2021-06-20 13:37:21', 1, '', 'Available', 1, 200, 200, 220, 'Cumila', '20', 'ACTIVE'),
...
(10, 'Data Communication & Networkin', '7080', -1, 7, 'English', '750', 9, '2020-04-13', '6th', '2021-06-26 21:56:45', 9, '', 'Available', 6, 1000, 1000, 1020, 'Cumilla', '35', 'ACTIVE'),
...
(12, 'C Programming Language', '4050', -1, 7, 'English', '800', 11, '2019-09-06', '5th', '2021-06-26 21:59:12', 9, '', 'Available', 6, 600, 600, 630, 'Dhaka', '25', 'ACTIVE'),
(13, 'C Plus Plus', '3050', 5, 6, 'English', '580', 10, '2019-02-06', '4th', '2021-06-26 22:01:16', 9, '', 'Available', 6, 400, 400, 430, 'Cumilla', '30', 'ACTIVE'),
(2043, 'Java Script', '5060', 4, 7, 'English', '400', 11, '2021-06-02', '4th', '2021-06-27 13:16:29', 9, '', 'AVAILABLE', 6, 400, 400, 420, 'Cumilla', '25', 'ACTIVE'),
(2044, 'shbd', '123', 9, 1, 'English', '100', 1, '2021-09-06', '10', '2021-09-06 00:49:10', 1, 'abc', 'AVAILABLE', 3, 100, 100, 10, 'location', '10', 'ACTIVE'),
(2045, 'islamic book', '66666', 1, 4, 'arabic', '600', 4, '2021-09-08', '1', '2021-09-08 15:40:38', 10, 'bbbbb', 'AVAILABLE', 1, 600, 450, 50, 'cumilla', '50', 'ACTIVE');
...
(6, 'Engineering', 'DELETED'),
(7, 'E-Book', 'ACTIVE'),
(8, 'Engineering', 'ACTIVE'),
(9, 'Islamic', 'ACTIVE');
...
(3, 'Jerin', 1797394840, 'jerintasnim40@gmail.com', '2021-03-02', 'Borrowed', 'DELETED'),
(4, 'Sakib', 1780509876, 'sakib77@gmail.com', '2021-09-15', '', 'DELETED'),
(5, 'Adnan', 1871233559, 'adnanfkc2002@gmail.com', '2021-09-15', 'Returned', 'ACTIVE'),
(6, 'Sazzad', 1854008967, 'sazzad20@gmail.com', '2021-09-14', 'Borrowed', 'ACTIVE'),
(7, 'Ovi', 1788097455, 'ovi334@gmail.com', '2021-09-14', 'Borrowed', 'ACTIVE');
...
(3, 'Rimi', 197554433, 'cumilla', '2020-10-21', 15000, 'admin', 'Richi', '6778', 'DELETED'),
(4, 'Tasnim', 196887765, 'Chittagong', '2021-04-12', 12000, 'salesman', 'Jerin', '5678', 'DELETED'),
(6, 'Sa', 0, '', '2021-09-15', 0, '', 'Mahmud', '6000', 'DELETED'),
(7, 'Tanim', 1977665544, 'Cumilla', '2021-09-15', 10000, '', 'Tanim', '1234', 'ACTIVE'),
(8, 'Nibrash', 2147483647, 'Dhaka', '2021-09-18', 10000, '', 'Mahmud', '6000', 'ACTIVE'),
(9, 'Sayla Sarmin', 1956742939, 'Cumilla', '2021-09-18', 10000, '', 'Mahmud', '6000', 'ACTIVE');
...
(22, 260, '2021-09-07', 1, 3, 'ACTIVE'),
(23, 200, '2021-09-08', 1, 1, 'ACTIVE'),
(24, 260, '2021-09-08', 1, 2, 'ACTIVE'),
(25, 360, '2021-09-08', 1, 2, 'ACTIVE'),
(26, 540, '2021-09-15', 1, 3, 'ACTIVE'),
(27, 260, '2021-09-15', 1, 3, 'ACTIVE'),
(28, 720, '2021-09-15', 1, 2, 'ACTIVE'),
(29, 450, '2021-09-15', 1, 4, 'ACTIVE'),
(30, 400, '2021-09-15', 1, 4, 'ACTIVE'),
(31, 600, '2021-09-15', 1, 3, 'ACTIVE'),
(32, 1000, '2021-09-15', 1, 1, 'ACTIVE'),
(33, 280, '2021-09-16', 2, 5, 'ACTIVE'),
(34, 300, '2021-09-18', 2, 4, 'ACTIVE');
...
(40, 3, 260, 1, 260, 260, 22, 'ACTIVE'),
(41, 8, 200, 1, 200, 200, 23, 'ACTIVE'),
(42, 3, 260, 1, 260, 260, 24, 'ACTIVE'),
(43, 5, 360, 1, 360, 350, 25, 'ACTIVE'),
(44, 4, 300, 1, 300, 300, 26, 'ACTIVE'),
(45, 2, 240, 1, 240, 240, 26, 'ACTIVE'),
(46, 3, 260, 1, 260, 260, 27, 'ACTIVE'),
(47, 5, 360, 2, 720, 350, 28, 'ACTIVE'),
(48, 2045, 450, 1, 450, 600, 29, 'ACTIVE'),
(49, 2043, 400, 1, 400, 400, 30, 'ACTIVE'),
(50, 12, 600, 1, 600, 600, 31, 'ACTIVE'),
(51, 10, 1000, 1, 1000, 1000, 32, 'ACTIVE'),
(52, 6, 280, 1, 280, 280, 33, 'ACTIVE'),
(53, 4, 300, 1, 300, 300, 34, 'ACTIVE');
...
(20, 1, 1, 1, '2021-09-07', '2021-09-04', '2021-09-04', 0, 'BORROWED', 'DELETED'),
(21, 8, 1, 1, '2021-09-08', '2021-09-09', '2021-09-09', 0, 'BORROWED', 'ACTIVE'),
(22, 3, 3, 1, '2021-09-08', '2021-09-10', '2021-09-10', 0, 'BORROWED', 'ACTIVE'),
(23, 10, 2, 1, '2021-09-15', '2021-09-13', '2021-09-13', 0, 'BORROWED', 'ACTIVE'),
(24, 8, 4, 1, '2021-09-15', '2021-09-15', '2021-09-15', 0, 'BORROWED', 'ACTIVE');
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `book_details`  AS SELECT `b`.`id` AS `id`, `b`.`title` AS `title`, `b`.`isbn` AS `isbn`, `b`.`publisher_id` AS `publisher_id`, `b`.`language` AS `language`, `b`.`number_of_page` AS `number_of_page`, `b`.`author_id` AS `author_id`, `b`.`publish_date` AS `publish_date`, `b`.`version` AS `version`, `b`.`date_time` AS `date_time`, `b`.`category_id` AS `category_id`, `b`.`description` AS `description`, `b`.`status` AS `status`, `b`.`book_type_id` AS `book_type_id`, `b`.`buying_price` AS `buying_price`, `b`.`selling_price` AS `selling_price`, `b`.`rent_price` AS `rent_price`, `b`.`location` AS `location`, `b`.`fine` AS `fine`, `b`.`column_status` AS `column_status`, `b`.`quantity` AS `quantity`, `p`.`name` AS `publisher_name`, `a`.`name` AS `author_name`, `c`.`name` AS `category_name`, `bt`.`name` AS `book_type_name` FROM ((((`books` `b` join `publishers` `p`) join `authors` `a`) join `book_types` `bt`) join `categories` `c`) WHERE `b`.`publisher_id` = `p`.`id` AND `b`.`author_id` = `a`.`id` AND `b`.`category_id` = `c`.`id` AND `b`.`book_type_id` = `bt`.`id` ;
...
--
ALTER TABLE `books`
  MODIFY `id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2046;
