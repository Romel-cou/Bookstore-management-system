...
function index()
{
    $s = "select * from employees order by id";
...
function store()
{
   ...
   //print_r($name);
    ...
    $s = "INSERT INTO `employees`(`id`, `name`, `phone`, `address`, `salary`,`username`,`password`) VALUES (null,'$name', '$phone','$address','$salary','$username','$password')";
    $id = executeQuery($s);
    print_r($id);
    if($id > 0)
    {
